...
import com.tomottowmust.system.common.RateLimitException;
import com.tomottowmust.system.common.RateLimitStrategy;
...
class RateLimitAspect {
    ...
    private String getUserId() {
        try {
            var user = com.tomottowmust.system.common.UserContext.getUser();
            return user != null ? String.valueOf(user.getId()) : "anonymous";
        } catch (Exception e) {
            return "anonymous";
        }
    }
